<template>
	<view class="page-add">
		<view class="add-form">
			<view class="add-form-item justify-end"><view class="add-btn" @click="navigateTo('/pages/auth/auth')">+添加场所</view></view>
			<view class="add-form-item">
				<view class="add-form-label">场所名称</view>
				<view class="add-form-content">
					<picker class="add-form-picker" mode="selector" :range="regions" range-key="Name" @change="getRegionCode">
			...
			<view class="add-form-item">
				...
				<view class="add-form-content flex">
