<template>
	<view class="add-form">
		<view class="add-form-item justify-end">
		...
		<view class="add-form-item">
			...
			<view class="add-form-content"><input class="add-form-input" type="text" v-model="positionName"
					placeholder="请输入布点位置" /></view>
		</view>
		<view class="add-form-item">
			<view class="add-form-label">疫情负责人</view>
			<view class="add-form-content"><input class="add-form-input" type="text" v-model="directorName"
					placeholder="请输入疫情负责人姓名" /></view>
		</view>
		<view class="add-form-item">
			<view class="add-form-label">手机号</view>
			<view class="add-form-content"><input class="add-form-input" type="text" v-model="directorPhone"
					placeholder="请输入疫情负责人手机号" /></view>
		</view>
		<view class="add-form-item">
